...
public class test {
    public static void main(String [] args)  {
        ...
        User user1 = new User("jmukaj","jonushi",3,"jon","mukaj","11/02/2002",
                "0682070864","jmukaj20@epoka.edu.al",2520);
        User user2 = new User("jmukaj","jonushi",2,"jon","mukaj","11/02/2002",
                "0682070864","jmukaj20@epoka.edu.al",3000);
        User user3 = new User("jmukaj","jonushi",1,"jon","mukaj","11/02/2002",
                "0682070864","jmukaj20@epoka.edu.al",5000);
