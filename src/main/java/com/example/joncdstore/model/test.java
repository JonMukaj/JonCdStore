...
public class test {
    public static void main(String [] args)  {
        ...
        User user1 = new User("jmukaj","jonushi",1,"jon","mukaj","11/02/2002",
                "0682070864","jmukaj20@epoka.edu.al",2520);
        User user2 = new User("fmarku","fabio2020",2,"fabio","marku","29/11/2001",
                "0682070864","fmarku20@epoka.edu.al",3000);
        User user3 = new User("ktenolli","kevin2021",3,"kevin","tenolli","06/04/2003",
