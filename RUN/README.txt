...
1.Click on jmukaj20.jar file
2. Click on execute.bat 
3. Execute the jar file from command line by first locating the directory where the jar is located and then
using the command java -jar  jmukaj20.jar

WARNING: Do not delete the files cd.ser and user.ser, if you want to access the application with different pre-made users. 
